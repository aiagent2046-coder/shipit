...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability(
        ...
        "chain, or a name bound once to the open call) is reported: the explicit opt-out is "
        ...
        "variable filters, ** spreads, rebound receivers, zipfile calls and cross-file "
