...
CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability(
        ...
        "declarations, conditional or multiple returns, deferred bodies (returned closures, "
        "generators and object/class methods have not drawn), nested helper chains, Python "
        "helpers, rebound or ambiguous sources, cross-file provenance and actual security use "
        "of the result are unresolved. Comments, docstrings and literal text are not draws. "
