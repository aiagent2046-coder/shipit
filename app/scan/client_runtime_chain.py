...
REASONS = (
    ...
    "pinned_scenario_selected",
    "operator_evidence_received",
    "evidence_consistency_validated",
)
...
def normalize_client_runtime_attachment(agent):
    ...
    try:
        matches = (
            record is not None
            and agent.get("client_runtime_status") == "accepted"
