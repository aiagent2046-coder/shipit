  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-10 leading-7">
      ...
      <section className="mt-8">
        ...
        <p className="mt-3">Fix Pack является цифровой услугой, оказываемой для конкретного аудита и репозитория. Если оплаченная услуга не была оказана по техническим причинам Drydock и пользователь не получил заявленный результат, пользователь вправе обратиться за возвратом денежных средств.</p>
      </section>
      ...
      <section className="mt-8">
        ...
        <p className="mt-3">Возврат производится, в частности, если Drydock подтвердил оплату, но не смог сформировать и предоставить Fix Pack в заявленном поддерживаемом сценарии из-за ошибки или недоступности своей инфраструктуры.</p>
      ...
      <section className="mt-8">
        ...
        <p className="mt-3">ИП Морозевская Кристина Олеговна, ИНН 672215400765, ОГРНИП 326670000033868. Телефон: +7 (999) 810-95-00. Email: support@drydock.co.</p>
      </section>
    </article>
  );
}
