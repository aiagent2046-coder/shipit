  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-10 leading-7">
      ...
      <section className="mt-8">
        ...
        <p className="mt-3">Возврат выполняется тем способом, который поддерживается платёжной системой для исходной операции. Срок зачисления средств на счёт Заказчика после направления распоряжения зависит от Robokassa, банка-эмитента и использованного платёжного метода и находится вне контроля Drydock.</p>
      </section>
