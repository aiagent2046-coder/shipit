...
import { FIXPACK_PRICE_RUB, PAYMENT_PROVIDER, REFUND_DAYS } from "../price";
    ...
    <article className="mx-auto max-w-3xl px-4 py-10 leading-7">
      ...
      <section className="mt-8">
        ...
        <ul className="mt-3 list-disc space-y-1 pl-6">
          ...
          <li>Адрес: 214030, г. Смоленск, ул. Некрасова, д. 16</li>
      ...
      <section className="mt-8">
        ...
        <p className="mt-3">Стоимость Fix Pack составляет <strong>{FIXPACK_PRICE_RUB} ₽ за один Fix Pack</strong>. Цена является фиксированной и не зависит от объёма репозитория, количества выявленных проблем и курсов валют. Услуга оплачивается один раз и не является подпиской. Автоматические повторные списания не производятся.</p>
        <p className="mt-3">Аудит репозитория предоставляется бесплатно. Платной является только услуга Fix Pack.</p>
        <p className="mt-3">Приём платежей осуществляется через платёжную систему {PAYMENT_PROVIDER}. До перехода к оплате Заказчик видит на сайте наименование услуги, номер заказа и итоговую сумму, совпадающую с ценой, указанной в настоящем разделе.</p>
        <p className="mt-3">Порядок оформления и оплаты заказа описан на русскоязычной странице Drydock в разделе «Как оформить и оплатить заказ» и доступен Заказчику до момента перехода к оплате.</p>
      </section>
      ...
      <section className="mt-8">
        ...
        <ol className="mt-3 list-decimal space-y-2 pl-6">
          ...
          <li>После получения подтверждения об оплате от {PAYMENT_PROVIDER} Drydock автоматически запускает задачу Fix Pack.</li>
