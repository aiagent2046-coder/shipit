...
export default function OfferPage() {
  return (
    <article className="mx-auto max-w-3xl px-4 py-10 leading-7">
      ...
      <section className="mt-8">
        <h2 className="text-xl font-semibold">5. Порядок оказания услуги</h2>
        <ol className="mt-3 list-decimal space-y-2 pl-6">
          ...
          <li>После подтверждения оплаты формируется задача Fix Pack.</li>
          <li>При успешном выполнении Заказчику предоставляется ссылка на созданный GitHub pull request.</li>
        </ol>
        <p className="mt-3">Срок зависит от размера проекта, доступности GitHub и инфраструктуры проверки. При технической невозможности оказать оплаченную услугу применяется порядок возврата, опубликованный на странице «Условия возврата денежных средств».</p>
      </section>
