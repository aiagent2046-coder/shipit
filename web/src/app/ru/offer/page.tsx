  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-10 leading-7">
      ...
      <section className="mt-8">
        ...
        <p className="mt-3">Оплата через {PAYMENT_PROVIDER} становится доступна после подключения магазина к платёжной системе. До перехода к оплате Заказчик видит на сайте наименование услуги и итоговую сумму заказа.</p>
        <p className="mt-3">Условия оплаты через {PAYMENT_PROVIDER} и ссылка на официальный сайт платёжной системы размещены на русскоязычной странице Drydock до момента перехода к оплате.</p>
      </section>
