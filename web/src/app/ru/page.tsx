  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10">
      ...
      <section className="mt-10 grid gap-5 md:grid-cols-3">
        <div className="rounded-xl border border-border bg-elevated p-5">
          ...
          <p className="mt-2 text-sm text-muted">
            Статические проверки безопасности, контроля доступа и настройки
            проекта, а также ограниченный предварительный анализ выбранного кода
            моделью, когда он доступен. Без оплаты и без подписки.
          </p>
        </div>
      ...
      <p className="mt-5 text-sm text-muted">
        Бесплатный анализ моделью охватывает только часть кода. Статические
        результаты сохраняются, если анализ моделью недоступен или выполнен
        частично, в том числе из-за лимита использования. Отчёт показывает, какая
        часть анализа выполнена и какие ограничения на неё повлияли.
        Fix Pack включает более глубокий анализ
        аутентификации и безопасности моделью со ссылкой на отдельный отчёт.
        Ни один из вариантов не гарантирует проверку каждого файла или обнаружение
        всех уязвимостей; область проверки и её ограничения указаны в отчёте.
      </p>
